    ...
    return (
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex items-center justify-between mb-4">
                <img height={10} width={50} src="https://cdn3.iconfinder.com/data/icons/social-network-30/512/social-06-512.png" />
                <h2 className="" class="text-lg font-semibold mr-20">YouTube</h2>
            </div>
            <p class="text-gray-600 mb-4">Chat with YouTube Platform</p>
